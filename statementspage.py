...
# -----------------Funtions frame ---------------#
        ...
        sold = Label(func_frame, font=medium_font, bg='#52c433', fg='white', padx=25,pady=10,relief=RIDGE, bd=5, width=8)
        sold.grid(row=1, column=4, rowspan=1, sticky=NE, padx=5)
        bought = Label(func_frame, font=medium_font, bg='#fa582f', fg='white', padx=25, pady=10, bd=5,relief=RIDGE, width=8)
...
# ---------------Delete Button-------------#
        ...
        def delete_func():
            ...
            confirm_button.grid(row = 4,column = 1, columnspan =2, sticky=S)
